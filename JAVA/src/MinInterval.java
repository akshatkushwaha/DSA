...
public class MinInterval {
    ...
    static class IntervalComparator implements Comparator<int[]> {
        ...
        public int compare(int[] o1, int[] o2) {
            int o1Size = getSize(o1);
            int o2Size = getSize(o2);
            if (o1Size != o2Size) {
    ...
    public static int[] minInterval(int[][] intervals, int[] queries) {
        ...
        Arrays.sort(sortedQueries, Comparator.comparingInt(q -> q.queryTimeStamp));
    ...
    public static void main(String[] args) {
        ...
        int[] queries = {2, 3, 4, 5};
        int[] response = minInterval(intervals, queries);
