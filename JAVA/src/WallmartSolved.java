...
class WallmartMaxHeap<T extends Comparable<T>> {
    private final int childCount;
    private final ArrayList<T> data;

    public WallmartMaxHeap(int childCount) {
...
public class WallmartSolved {
    public static void main(String[] args) {
        WallmartMaxHeap<Integer> heap = new WallmartMaxHeap<Integer>(2);
